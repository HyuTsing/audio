...
class FeedBackNet(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(4):
            ...
            a5=torch.cat((a1,a2,a3,a4),dim=1)
            b1 = self.conv2(a5)
            b2 = self.conv2a(a5)
            b3 = self.conv2b(a5)
            b4=self.conv2c(a5)
            ...
            c3 = self.conv3b(b5)
            c4 = self.conv3c(b5)
            c5=torch.cat((c1,c2,c3,c4),dim=1)
            d1 = self.conv4(c5)
            d2 = self.conv4a(c5)
            d3 = self.conv4b(c5)
            d4 = self.conv4c(c5)
